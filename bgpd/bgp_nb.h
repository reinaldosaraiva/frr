...
/* s062 — Fase D fatia 2: per-neighbor families (ctx-generic) */
...
int bgp_neighbor_af_default_originate_originate_modify(struct nb_cb_modify_args *args);
int bgp_neighbor_af_default_originate_route_map_destroy(struct nb_cb_destroy_args *args);
int bgp_neighbor_af_default_originate_route_map_modify(struct nb_cb_modify_args *args);
...
int bgp_neighbor_af_send_ext_community_rpki_modify(struct nb_cb_modify_args *args);
...
int bgp_peer_admin_shutdown_rtt_count_destroy(struct nb_cb_destroy_args *args);
...
int bgp_peer_aigp_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_aigp_modify(struct nb_cb_modify_args *args);
int bgp_peer_as_loop_detection_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_as_loop_detection_modify(struct nb_cb_modify_args *args);
...
int bgp_peer_capability_dynamic_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_capability_dynamic_modify(struct nb_cb_modify_args *args);
int bgp_peer_capability_extended_nexthop_modify(struct nb_cb_modify_args *args);
int bgp_peer_capability_fqdn_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_capability_fqdn_modify(struct nb_cb_modify_args *args);
int bgp_peer_capability_link_local_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_capability_link_local_modify(struct nb_cb_modify_args *args);
int bgp_peer_capability_negotiate_modify(struct nb_cb_modify_args *args);
int bgp_peer_capability_override_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_capability_override_modify(struct nb_cb_modify_args *args);
int bgp_peer_capability_software_version_modify(struct nb_cb_modify_args *args);
int bgp_peer_capability_strict_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_capability_strict_modify(struct nb_cb_modify_args *args);
...
int bgp_peer_disable_connected_check_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_disable_connected_check_modify(struct nb_cb_modify_args *args);
int bgp_peer_disable_link_bw_encoding_ieee_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_disable_link_bw_encoding_ieee_modify(struct nb_cb_modify_args *args);
...
int bgp_peer_enforce_first_as_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_enforce_first_as_modify(struct nb_cb_modify_args *args);
int bgp_peer_extended_link_bandwidth_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_extended_link_bandwidth_modify(struct nb_cb_modify_args *args);
int bgp_peer_extended_optional_parameters_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_extended_optional_parameters_modify(struct nb_cb_modify_args *args);
...
int bgp_peer_graceful_shutdown_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_graceful_shutdown_modify(struct nb_cb_modify_args *args);
int bgp_peer_ip_transparent_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_ip_transparent_modify(struct nb_cb_modify_args *args);
...
int bgp_peer_passive_mode_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_passive_mode_modify(struct nb_cb_modify_args *args);
...
int bgp_peer_path_attribute_treat_as_withdraw_create(struct nb_cb_create_args *args);
int bgp_peer_path_attribute_treat_as_withdraw_destroy(struct nb_cb_destroy_args *args);
...
int bgp_peer_rpki_strict_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_rpki_strict_modify(struct nb_cb_modify_args *args);
int bgp_peer_send_nexthop_characteristics_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_send_nexthop_characteristics_modify(struct nb_cb_modify_args *args);
int bgp_peer_solo_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_solo_modify(struct nb_cb_modify_args *args);
int bgp_peer_tcp_mss_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_tcp_mss_modify(struct nb_cb_modify_args *args);
int bgp_peer_timers_advertise_interval_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_timers_advertise_interval_modify(struct nb_cb_modify_args *args);
...
int bgp_peer_v6only_modify(struct nb_cb_modify_args *args);
void bgp_neighbor_af_send_ext_community_rpki_cli_show(struct vty *vty,
...
int bgp_peer_capability_override_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_capability_override_modify(struct nb_cb_modify_args *args);
int bgp_peer_capability_software_version_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_capability_software_version_modify(struct nb_cb_modify_args *args);
int bgp_peer_capability_strict_destroy(struct nb_cb_destroy_args *args);
int bgp_peer_capability_strict_modify(struct nb_cb_modify_args *args);
int bgp_peer_description_destroy(struct nb_cb_destroy_args *args);
