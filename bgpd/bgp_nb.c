...
#define BGP_NB_GAF_XPATH(_af, _leaf) \
	"/frr-routing:routing/control-plane-protocols/control-plane-protocol/" \
	"frr-bgp:bgp/global/afi-safis/afi-safi/" _af "/" _leaf
...
#undef BGP_NB_UNNB_XPATH
		...
		/* ====== S063: global/afi-safis + resto ====== */


/*
 * S063: literal-xpath helper for the global daemon tail (keeps the
 * table entries under the checkpatch line limit without splitting
 * string literals).
 */
#define BGP_NB_GLBL_XPATH(_leaf)                                              \
	"/frr-routing:routing/control-plane-protocols/"                      \
	"control-plane-protocol/frr-bgp:bgp/global/" _leaf

		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route"),
		  .cbs = { .create = bgp_gaf_aggregate_create,
				   .destroy = bgp_gaf_aggregate_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route"),
		  .cbs = { .create = bgp_gaf_aggregate_create,
				   .destroy = bgp_gaf_aggregate_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-multicast",
			  "aggregate-route"),
		  .cbs = { .create = bgp_gaf_aggregate_create,
				   .destroy = bgp_gaf_aggregate_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-multicast",
			  "aggregate-route"),
		  .cbs = { .create = bgp_gaf_aggregate_create,
				   .destroy = bgp_gaf_aggregate_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-labeled-unicast",
			  "aggregate-route"),
		  .cbs = { .create = bgp_gaf_aggregate_create,
				   .destroy = bgp_gaf_aggregate_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
			  "aggregate-route"),
		  .cbs = { .create = bgp_gaf_aggregate_create,
				   .destroy = bgp_gaf_aggregate_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/as-set"),
		  .cbs = { .modify = bgp_gaf_aggregate_as_set_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/as-set"),
		  .cbs = { .modify = bgp_gaf_aggregate_as_set_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-multicast",
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .modify = bgp_gaf_aggregate_as_set_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/summary-only"),
		  .cbs = { .modify = bgp_gaf_aggregate_summary_only_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/summary-only"),
		  .cbs = { .modify = bgp_gaf_aggregate_summary_only_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-multicast",
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .modify = bgp_gaf_aggregate_summary_only_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/rmap-policy-export"),
		  .cbs = { .destroy = bgp_gaf_aggregate_rmap_policy_export_destroy,
				   .modify = bgp_gaf_aggregate_rmap_policy_export_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/rmap-policy-export"),
		  .cbs = { .destroy = bgp_gaf_aggregate_rmap_policy_export_destroy,
				   .modify = bgp_gaf_aggregate_rmap_policy_export_modify } },
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .destroy = bgp_gaf_aggregate_rmap_policy_export_destroy,
				   .modify = bgp_gaf_aggregate_rmap_policy_export_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/origin"),
		  .cbs = { .modify = bgp_gaf_aggregate_origin_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/origin"),
		  .cbs = { .modify = bgp_gaf_aggregate_origin_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-multicast",
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .modify = bgp_gaf_aggregate_origin_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/match-med"),
		  .cbs = { .modify = bgp_gaf_aggregate_match_med_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/match-med"),
		  .cbs = { .modify = bgp_gaf_aggregate_match_med_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-multicast",
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .modify = bgp_gaf_aggregate_match_med_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/suppress-map"),
		  .cbs = { .destroy = bgp_gaf_aggregate_suppress_map_destroy,
				   .modify = bgp_gaf_aggregate_suppress_map_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/suppress-map"),
		  .cbs = { .destroy = bgp_gaf_aggregate_suppress_map_destroy,
				   .modify = bgp_gaf_aggregate_suppress_map_modify } },
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/upa"),
		  .cbs = { .modify = bgp_gaf_aggregate_upa_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/upa"),
		  .cbs = { .modify = bgp_gaf_aggregate_upa_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-multicast",
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .modify = bgp_gaf_aggregate_upa_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/upa-drop"),
		  .cbs = { .modify = bgp_gaf_aggregate_upa_drop_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/upa-drop"),
		  .cbs = { .modify = bgp_gaf_aggregate_upa_drop_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-multicast",
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .modify = bgp_gaf_aggregate_upa_drop_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/upa-max-routes"),
		  .cbs = { .modify = bgp_gaf_aggregate_upa_max_routes_modify,
				   .destroy = bgp_gaf_aggregate_upa_max_routes_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/upa-max-routes"),
		  .cbs = { .modify = bgp_gaf_aggregate_upa_max_routes_modify,
				   .destroy = bgp_gaf_aggregate_upa_max_routes_destroy } },
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .modify = bgp_gaf_aggregate_upa_max_routes_modify,
				   .destroy = bgp_gaf_aggregate_upa_max_routes_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/community"),
		  .cbs = { .modify = bgp_gaf_aggregate_community_modify,
				   .destroy = bgp_gaf_aggregate_community_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/community"),
		  .cbs = { .modify = bgp_gaf_aggregate_community_modify,
				   .destroy = bgp_gaf_aggregate_community_destroy } },
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .modify = bgp_gaf_aggregate_community_modify,
				   .destroy = bgp_gaf_aggregate_community_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/extended-community"),
		  .cbs = { .modify = bgp_gaf_aggregate_extended_community_modify,
				   .destroy = bgp_gaf_aggregate_extended_community_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/extended-community"),
		  .cbs = { .modify = bgp_gaf_aggregate_extended_community_modify,
				   .destroy = bgp_gaf_aggregate_extended_community_destroy } },
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .modify = bgp_gaf_aggregate_extended_community_modify,
				   .destroy = bgp_gaf_aggregate_extended_community_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/large-community"),
		  .cbs = { .modify = bgp_gaf_aggregate_large_community_modify,
				   .destroy = bgp_gaf_aggregate_large_community_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/large-community"),
		  .cbs = { .modify = bgp_gaf_aggregate_large_community_modify,
				   .destroy = bgp_gaf_aggregate_large_community_destroy } },
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .modify = bgp_gaf_aggregate_large_community_modify,
				   .destroy = bgp_gaf_aggregate_large_community_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "aggregate-route/as-path"),
		  .cbs = { .modify = bgp_gaf_aggregate_as_path_modify,
				   .destroy = bgp_gaf_aggregate_as_path_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "aggregate-route/as-path"),
		  .cbs = { .modify = bgp_gaf_aggregate_as_path_modify,
				   .destroy = bgp_gaf_aggregate_as_path_destroy } },
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "route-flap-dampening/enable"),
		  .cbs = { .modify = bgp_gaf_dampening_enable_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "route-flap-dampening/reach-decay"),
		  .cbs = { .destroy = bgp_gaf_dampening_destroy,
				   .modify = bgp_gaf_dampening_params_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "route-flap-dampening/reuse-above"),
		  .cbs = { .destroy = bgp_gaf_dampening_destroy,
				   .modify = bgp_gaf_dampening_params_modify } },
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .destroy = bgp_gaf_dampening_destroy,
				   .modify = bgp_gaf_dampening_params_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "use-multiple-paths/ebgp/maximum-paths"),
		  .cbs = { .destroy = bgp_gaf_maxpaths_ebgp_destroy,
				   .modify = bgp_gaf_maxpaths_ebgp_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "use-multiple-paths/ibgp/maximum-paths"),
		  .cbs = { .destroy = bgp_gaf_maxpaths_ibgp_destroy,
				   .modify = bgp_gaf_maxpaths_ibgp_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "use-multiple-paths/ibgp/cluster-length-list"),
		  .cbs = { .modify = bgp_gaf_cluster_length_list_modify,
				   .destroy = bgp_gaf_cluster_length_list_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "use-multiple-paths/ebgp/maximum-paths"),
		  .cbs = { .destroy = bgp_gaf_maxpaths_ebgp_destroy,
				   .modify = bgp_gaf_maxpaths_ebgp_modify } },
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		  ...
		  .cbs = { .modify = bgp_gaf_cluster_length_list_modify,
				   .destroy = bgp_gaf_cluster_length_list_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "admin-distance/external"),
		  .cbs = { .modify = bgp_gaf_distance_external_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "admin-distance/internal"),
		  .cbs = { .modify = bgp_gaf_distance_internal_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "admin-distance/local"),
		  .cbs = { .modify = bgp_gaf_distance_local_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "admin-distance-route"),
		  .cbs = { .create = bgp_gaf_distance_route_create,
				   .destroy = bgp_gaf_distance_route_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "admin-distance-route/distance"),
		  .cbs = { .modify = bgp_gaf_distance_route_distance_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "admin-distance-route/access-list"),
		  .cbs = { .destroy = bgp_gaf_distance_route_access_list_destroy,
				   .modify = bgp_gaf_distance_route_access_list_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "admin-distance-route/access-list-policy-export"),
		  .cbs = { .destroy = bgp_gaf_distance_route_acl_export_destroy,
				   .modify = bgp_gaf_distance_route_acl_export_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "admin-distance/external"),
		  .cbs = { .modify = bgp_gaf_distance_external_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "filter-config/rmap-export"),
		  .cbs = { .destroy = bgp_gaf_table_map_destroy,
				   .modify = bgp_gaf_table_map_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "filter-config/rmap-export"),
		  .cbs = { .destroy = bgp_gaf_table_map_destroy,
				   .modify = bgp_gaf_table_map_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-multicast",
		  ...
		  .cbs = { .destroy = bgp_gaf_table_map_destroy,
				   .modify = bgp_gaf_table_map_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("l3vpn-ipv4-unicast",
			  "retain-route-target-all"),
		  .cbs = { .modify = bgp_gaf_retain_rt_all_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("l3vpn-ipv6-unicast",
			  "retain-route-target-all"),
		  .cbs = { .modify = bgp_gaf_retain_rt_all_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-flowspec",
			  "flow-spec-config/local-install/enable"),
		  .cbs = { .modify = bgp_gaf_fs_local_install_enable_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-flowspec",
			  "flow-spec-config/local-install/interface"),
		  .cbs = { .create = bgp_gaf_fs_local_install_if_create,
				   .destroy = bgp_gaf_fs_local_install_if_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-flowspec",
			  "flow-spec-config/local-install/enable"),
		  .cbs = { .modify = bgp_gaf_fs_local_install_enable_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-flowspec",
			  "flow-spec-config/local-install/interface"),
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/rd"),
		  .cbs = { .destroy = bgp_gaf_vpn_rd_destroy, .modify = bgp_gaf_vpn_rd_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/label"),
		  .cbs = { .destroy = bgp_gaf_vpn_label_destroy,
				   .modify = bgp_gaf_vpn_label_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/label-auto"),
		  .cbs = { .destroy = bgp_gaf_vpn_label_auto_destroy,
				   .modify = bgp_gaf_vpn_label_auto_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/nexthop"),
		  .cbs = { .destroy = bgp_gaf_vpn_nexthop_destroy,
				   .modify = bgp_gaf_vpn_nexthop_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/import-vpn"),
		  .cbs = { .modify = bgp_gaf_vpn_import_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/export-vpn"),
		  .cbs = { .modify = bgp_gaf_vpn_export_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/rmap-import"),
		  .cbs = { .destroy = bgp_gaf_vpn_rmap_import_destroy,
				   .modify = bgp_gaf_vpn_rmap_import_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/rmap-export"),
		  .cbs = { .destroy = bgp_gaf_vpn_rmap_export_destroy,
				   .modify = bgp_gaf_vpn_rmap_export_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/vrf-rmap-import"),
		  .cbs = { .destroy = bgp_gaf_vpn_vrf_rmap_import_destroy,
				   .modify = bgp_gaf_vpn_vrf_rmap_import_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/redirect-rt"),
		  .cbs = { .destroy = bgp_gaf_vpn_redirect_rt_destroy,
				   .modify = bgp_gaf_vpn_redirect_rt_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/redirect-rt-ipv6"),
		  .cbs = { .modify = bgp_gaf_vpn_redirect_rt_ipv6_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/export-allocation-mode"),
		  .cbs = { .modify = bgp_gaf_vpn_export_alloc_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/import-rt-list"),
		  .cbs = { .create = bgp_gaf_vpn_import_rt_list_create,
				   .destroy = bgp_gaf_vpn_import_rt_list_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/export-rt-list"),
		  .cbs = { .create = bgp_gaf_vpn_export_rt_list_create,
				   .destroy = bgp_gaf_vpn_export_rt_list_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "vpn-config/import-vrf-list"),
		  .cbs = { .create = bgp_gaf_vpn_import_vrf_list_create,
				   .destroy = bgp_gaf_vpn_import_vrf_list_destroy } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "vpn-config/rd"),
		  .cbs = { .destroy = bgp_gaf_vpn_rd_destroy, .modify = bgp_gaf_vpn_rd_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "upa/max-routes"),
		  .cbs = { .modify = bgp_gaf_upa_max_routes_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "upa/drop"),
		  .cbs = { .modify = bgp_gaf_upa_drop_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv4-unicast",
			  "upa/originate-all"),
		  .cbs = { .modify = bgp_gaf_upa_originate_all_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "upa/max-routes"),
		  .cbs = { .modify = bgp_gaf_upa_max_routes_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
		...
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-unicast",
			  "prefer-global"),
		  .cbs = { .modify = bgp_gaf_prefer_global_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-multicast",
			  "prefer-global"),
		  .cbs = { .modify = bgp_gaf_prefer_global_modify } },
		{ .xpath = BGP_NB_GAF_XPATH("ipv6-labeled-unicast",
		...
		{ .xpath = "/frr-bgp:bgp-daemon/update-delay-time",
		  .cbs = { .modify = bgp_daemon_update_delay_modify,
				   .destroy = bgp_daemon_update_delay_destroy } },
		{ .xpath = "/frr-bgp:bgp-daemon/advertisement-delay-time",
		  .cbs = { .destroy = bgp_daemon_adv_delay_destroy,
				   .modify = bgp_daemon_adv_delay_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/establish-wait-time",
		  .cbs = { .destroy = bgp_daemon_establish_wait_destroy,
				   .modify = bgp_daemon_establish_wait_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/rmap-delay-time",
		  .cbs = { .modify = bgp_daemon_rmap_delay_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/input-queue-limit",
		  .cbs = { .modify = bgp_daemon_input_queue_modify,
				   .destroy = bgp_daemon_input_queue_destroy } },
		{ .xpath = "/frr-bgp:bgp-daemon/output-queue-limit",
		  .cbs = { .destroy = bgp_daemon_output_queue_destroy,
				   .modify = bgp_daemon_output_queue_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/ipv6-auto-ra",
		  .cbs = { .modify = bgp_daemon_ipv6_auto_ra_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/no-rib",
		  .cbs = { .modify = bgp_daemon_no_rib_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/send-extra-data",
		  .cbs = { .modify = bgp_daemon_send_extra_data_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/session-dscp",
		  .cbs = { .destroy = bgp_daemon_session_dscp_destroy,
				   .modify = bgp_daemon_session_dscp_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/suppress-fib-pending",
		  .cbs = { .modify = bgp_daemon_suppress_fib_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/suppress-fib-pending-delay",
		  .cbs = { .modify = bgp_daemon_suppress_fib_delay_modify,
				   .destroy = bgp_daemon_suppress_fib_delay_destroy } },
		{ .xpath = "/frr-bgp:bgp-daemon/graceful-restart/enabled",
		  .cbs = { .destroy = bgp_daemon_gr_enabled_destroy,
				   .modify = bgp_daemon_gr_enabled_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/graceful-restart/graceful-restart-disable",
		  .cbs = { .destroy = bgp_daemon_gr_disable_destroy,
				   .modify = bgp_daemon_gr_disable_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/graceful-restart/restart-time",
		  .cbs = { .modify = bgp_daemon_gr_restart_time_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/graceful-restart/rib-stale-time",
		  .cbs = { .modify = bgp_daemon_gr_stale_time_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/graceful-restart/stale-routes-time",
		  .cbs = { .modify = bgp_daemon_gr_stale_routes_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/graceful-restart/long-lived-stale-time",
		  .cbs = { .modify = bgp_daemon_gr_ll_stale_time_modify,
				   .destroy = bgp_daemon_gr_ll_stale_time_destroy } },
		{ .xpath = "/frr-bgp:bgp-daemon/graceful-restart/selection-deferral-time",
		  .cbs = { .modify = bgp_daemon_gr_select_defer_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/graceful-restart/disable-eor",
		  .cbs = { .modify = bgp_daemon_gr_disable_eor_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/graceful-restart/notification",
		  .cbs = { .modify = bgp_daemon_gr_notification_modify,
				   .destroy = bgp_daemon_gr_notification_destroy } },
		{ .xpath = "/frr-bgp:bgp-daemon/graceful-restart/preserve-fw-entry",
		  .cbs = { .modify = bgp_daemon_gr_preserve_fw_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/graceful-shutdown/enable",
		  .cbs = { .modify = bgp_daemon_gs_enable_modify } },
		{ .xpath = "/frr-bgp:bgp-daemon/community-alias/alias",
		  .cbs = { .modify = bgp_daemon_community_alias_modify } },
		{ .xpath = BGP_NB_GLBL_XPATH("as-notation"),
		  .cbs = { .destroy = bgp_global_as_notation_destroy,
				   .modify = bgp_global_as_notation_modify } },
		{ .xpath = BGP_NB_GLBL_XPATH("default-afi-safi"),
		  .cbs = { .create = bgp_global_default_afi_safi_create,
				   .destroy = bgp_global_default_afi_safi_destroy } },
		{ .xpath = BGP_NB_GLBL_XPATH("global-config-timers/rmap-delay-time"),
		  .cbs = { .modify = bgp_global_rmap_delay_modify } },
		{ .xpath = BGP_NB_GLBL_XPATH("global-config-timers/tcp-keepalive/idle"),
		  .cbs = { .modify = bgp_global_tcp_keepalive_idle_modify,
				   .destroy = bgp_global_tcp_keepalive_idle_destroy } },
		{ .xpath = BGP_NB_GLBL_XPATH("global-config-timers/tcp-keepalive/interval"),
		  .cbs = { .destroy = bgp_global_tcp_keepalive_interval_destroy,
				   .modify = bgp_global_tcp_keepalive_interval_modify } },
		{ .xpath = BGP_NB_GLBL_XPATH("global-config-timers/tcp-keepalive/probes"),
		  .cbs = { .destroy = bgp_global_tcp_keepalive_probes_destroy,
				   .modify = bgp_global_tcp_keepalive_probes_modify } },
		{ .xpath = BGP_NB_GLBL_XPATH("graceful-restart/graceful-restart-disable"),
		  .cbs = { .destroy = bgp_global_gr_disable_destroy,
				   .modify = bgp_global_gr_disable_modify } },
		{ .xpath = BGP_NB_GLBL_XPATH("graceful-restart/disable-eor"),
		  .cbs = { .modify = bgp_global_gr_disable_eor_modify } },
		{ .xpath = BGP_NB_GLBL_XPATH("local-as"),
		  .cbs = { .modify = bgp_global_local_as_modify } },
		{ .xpath = BGP_NB_GLBL_XPATH("med-config/enable-med-admin"),
		  .cbs = { .modify = bgp_global_med_admin_enable_modify } },
		{ .xpath = BGP_NB_GLBL_XPATH("med-config/max-med-admin"),
		  .cbs = { .modify = bgp_global_med_admin_max_modify } },
		{ .xpath = BGP_NB_GLBL_XPATH("med-config/max-med-onstart-up-time"),
		  .cbs = { .modify = bgp_global_med_onstart_time_modify,
				   .destroy = bgp_global_med_onstart_time_destroy } },
		{ .xpath = BGP_NB_GLBL_XPATH("med-config/max-med-onstart-up-value"),
		  .cbs = { .modify = bgp_global_med_onstart_value_modify } },
		{ .xpath = "/frr-interface:lib/interface/frr-bgp:mpls-bgp-forwarding",
		  .cbs = { .modify = bgp_if_mpls_bgp_forwarding_modify } },
		{ .xpath = "/frr-interface:lib/interface/frr-bgp:mpls-l3vpn-multi-domain-switching",
		  .cbs = { .modify = bgp_if_mpls_l3vpn_multi_domain_modify } },

		/* S063: remaining container lifecycles */
		{ .xpath = BGP_NB_GLBL_XPATH("afi-safis/afi-safi"),
			  .cbs = { .create = bgp_gaf_afi_safi_create,
				   .destroy = bgp_gaf_afi_safi_destroy,
				   .flags = F_NB_CB_DESTROY_RECURSE } },
		{
			.xpath = "/frr-bgp:bgp-daemon/community-alias",
			.cbs = { .create = bgp_daemon_community_alias_create,
				 .destroy = bgp_daemon_community_alias_destroy },
		},
		{
			.xpath = NULL,
		},
